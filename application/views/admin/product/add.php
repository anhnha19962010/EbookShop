            ...
            <form role="form" action="" method="POST" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="docs" class="form-control" id="txtSelectedFile1" style="cursor:pointer;" value="Chọn tệp" onclick="openCustomRoxy('roxyCustomPanel4', '<?php echo site_url() ?>public/fileman/custom.html?integration=custom&type=files&txtFieldId=txtSelectedFile1&preview=thumbPreview1&dialog=roxyCustomPanel4')">
